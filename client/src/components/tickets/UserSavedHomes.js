...
import { faCircleXmark, faHouseUser, faLocationDot } from "@fortawesome/free-solid-svg-icons";
import "./Card.css";
  ...
  return (
    <div className="container mt-4">
      ...
      >
        <h4>
          {" "}
          <FontAwesomeIcon icon={faHouseUser} /> <>Saved Properties</>
        </h4>
      </div>
      <div className="search-wrapper" style={{display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
        <div >
        <Input
        ...
        <div>
          <Button 
          color="primary"
          onClick={clearFilters}> <FontAwesomeIcon icon={faCircleXmark} /> Reset</Button>
        </div>
      </div>
